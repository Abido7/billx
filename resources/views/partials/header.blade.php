                        ...
                        @foreach ($naveBarItems as $page)
                            <li class="nav-item">
                                <a role="button" class="nav-link" href="{{ url("$page->link") }}">
                                    {{ __(str_replace('-', ' ', strtoupper($page->title))) }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
                    <div class="setting-nav d-flex">
                        ...
                        @if (isset($route) && $route === 'pos')
                            <a class="btn btn-outline-primary-light only d-flex align-items-center mx-2"
                                ...
                                {{ __('Login') }}
                                <svg class="d-block ms-2" width="13" height="12" viewBox="0 0 13 12"
                        ...
                        @elseif(isset($route) && $route === 'gps')
                            <a class="btn btn-outline-primary-light only d-flex align-items-center mx-2"
                                href="{{ url('http://www.billxgps.com') }}">
                                {{ __('Login') }}
                                <svg class="d-block ms-2" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
